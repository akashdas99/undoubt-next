...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "bordered-card text-card-foreground gap-6 overflow-hidden py-6 text-sm has-[>img:first-child]:pt-0 data-[size=sm]:gap-4 data-[size=sm]:py-4 group/card flex flex-col",
        className,
      )}
      {...props}
    />
